...
public class ListQuizEtudiantController {
    ...
    private void refreshQuizList() {
        allQuizzes = serviceQuiz.getAll(); // Store the full list
        System.out.println("Refreshed quiz list. Total quizzes retrieved: " + allQuizzes.size());
        filterQuizzes(searchField.getText()); // Apply any existing search filter
    }
